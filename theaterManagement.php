                            ...
                            <div class="card-body">
                                <div class="movieListHeadingContainer">
                                    ...
                                    <div class="searchMovieContainer">
                                        ...
                                        <input type="text" class="form-control" id="search-input" placeholder="Search Theaters">
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><img class="posterImage" src="theaterImages/<?php echo $theaterImage ?>" id="theaterImage" alt=""></td>
                                                        </td>
