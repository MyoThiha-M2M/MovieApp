                                ...
                                <div class="movieEntryContainer">
                                    <div class="movieUploadRow">
                                        ...
                                        <div class="moviePosterContainer">
                                            <div class="wrapper">
                                                <div class="image">
                                                    <img src="moviePosters/<?php echo $poster2 ?>" alt=""
                                                        class="image1">
                                                </div>
                                                <!-- <div class="uploadContent">
                                                    <div class="icon"><i class="fas fa-cloud-upload-alt"></i></div>
                                        ...
                                        <div class="moviePosterContainer">
                                            <div class="wrapper">
                                                <div class="image">
                                                    <img src="moviePosters/<?php echo $poster3 ?>" alt=""
                                                        class="image1">
                                                </div>
                                                <!-- <div class="uploadContent">
                                                    <div class="icon"><i class="fas fa-cloud-upload-alt"></i></div>
                                        ...
                                        <div class="movieTrailerContainer">
                                            <div class="wrapper">
                                                <div class="video">
                                                    <!-- <img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                        alt="" class="image1"> -->
                                                    <video src="" class="movieTrailer" width="100%"
                                                        height="100%"></video>
                                                </div>
                                                <div class="uploadContent">
                                                    <div class="icon"><i class="fas fa-cloud-upload-alt"></i></div>
